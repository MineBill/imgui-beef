...
public static class ImGui
{
    ...
    public typealias StbTexteditState = STB_TexteditState;
...
public struct DrawList
{
    ...
    [LinkName("ImDrawList__SetTextureID")]
    private static extern void SetTextureIDImpl(Self* self, TextureID texture_id);
    public void SetTextureID(TextureID texture_id) mut=> SetTextureIDImpl(&this, texture_id);
...
[LinkName("igGetIOEx")]
private static extern IO* GetIOExImpl(Context* ctx);
#if IMGUI_USE_REF
public static ref IO GetIOEx(Context* ctx) { return ref *GetIOExImpl(ctx); }
#else
public static IO* GetIOEx(Context* ctx) => GetIOExImpl(ctx);
#endif
...
[LinkName("igGetPlatformIOEx")]
private static extern PlatformIO* GetPlatformIOExImpl(Context* ctx);
#if IMGUI_USE_REF
public static ref PlatformIO GetPlatformIOEx(Context* ctx) { return ref *GetPlatformIOExImpl(ctx); }
#else
public static PlatformIO* GetPlatformIOEx(Context* ctx) => GetPlatformIOExImpl(ctx);
#endif
...
private static extern bool ImageButtonExImpl(ID id, TextureID user_texture_id, Vec2 image_size, Vec2 uv0, Vec2 uv1, Vec4 bg_col, Vec4 tint_col, ButtonFlags flags);
public static bool ImageButtonEx(ID id, TextureID user_texture_id, Vec2 image_size, Vec2 uv0, Vec2 uv1, Vec4 bg_col, Vec4 tint_col, ButtonFlags flags = (ButtonFlags) 0) => ImageButtonExImpl(id, user_texture_id, image_size, uv0, uv1, bg_col, tint_col, flags);
